                    ...
                    if (!AppSingletons.isSubscriptionEnabled.value) {
                      ...
                      if (AppSingletons.isInvoiceDocument.value) {
                        AppSingletons.invoiceTemplateIdINV.value =
                            controller.fullyVisibleIndex.value.toString();
                        AppSingletons.selectedTempIndexToCheck.value =
                            controller.fullyVisibleIndex.value;
                        Get.back();
                        debugPrint(
      ...
      children: [
            ...
            children: [
              Container(
                ...
                margin: EdgeInsets.only(
                    top: controller.fullyVisibleIndex.value == 0 ? 5 : 15,
                    bottom: controller.fullyVisibleIndex.value == 0 ? 90 : 100
                ),
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 5 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 5 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 6 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 6 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 7 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 7 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 8 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 8 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 9 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 9 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 10 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 10 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
              future: controller.pdf10,
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CupertinoActivityIndicator(
                    color: mainPurpleColor, radius: 15,));
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 11 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 11 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
              future: controller.pdf11,
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CupertinoActivityIndicator(
                    color: mainPurpleColor, radius: 15,));
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 12 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 12 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
              future: controller.pdf12,
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CupertinoActivityIndicator(
                    color: mainPurpleColor, radius: 15,));
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 13 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 13 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
              future: controller.pdf13,
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CupertinoActivityIndicator(
                    color: mainPurpleColor, radius: 15,));
        ...
        Obx(() {
          return Container(
            ...
            width: 300,
            margin: EdgeInsets.only(
                top: controller.fullyVisibleIndex.value == 14 ? 5 : 15,
                bottom: controller.fullyVisibleIndex.value == 14 ? 90 : 100
            ),
            child: FutureBuilder<Uint8List>(
              future: controller.pdf14,
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return const Center(child: CupertinoActivityIndicator(
                    color: mainPurpleColor, radius: 15,));
