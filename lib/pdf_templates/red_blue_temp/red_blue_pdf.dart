...
class PdfRedBlueTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    await loadImageFromAssets('assets/images/red_blue.jpg');
  ...
  static Widget buildItemDetail(
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFF019fca)),
          
          oddRowDecoration: const pw.BoxDecoration(
            color: PdfColor.fromInt(0xFFB5E2FE)
          ),
            ...
            children: [
              ...
              pw.Expanded(
                  child: pw.Column(children: [
                    ...
                    pw.SizedBox(height: 0.5 * PdfPageFormat.cm),
                    pw.Container(
                        color: const PdfColor.fromInt(0xFF019fca),
