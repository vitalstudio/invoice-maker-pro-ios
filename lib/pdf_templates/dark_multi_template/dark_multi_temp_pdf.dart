...
class PdfDarkMultiTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    await loadImageFromAssets('assets/images/dark_multi_shade.jpg');
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerStyle: pw.TextStyle(
              ...
              font: boldFont,
              color: PdfColors.white),
          headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFFce2a19)),

          oddRowDecoration: const pw.BoxDecoration(
              color: PdfColor.fromInt(0xFFF99E85)
          ),
            ...
            children: [
              ...
              pw.Expanded(
                  child: pw.Column(children: [
                    ...
                    pw.SizedBox(height: 0.5 * PdfPageFormat.cm),
                    pw.Container(
                        color: const PdfColor.fromInt(0xFFce2a19),
