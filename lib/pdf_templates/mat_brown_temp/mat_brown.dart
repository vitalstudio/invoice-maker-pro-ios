...
class PdfMatBrownTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    final Uint8List imageData =
        await loadImageFromAssets('assets/images/mat_brown.jpg');
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (format) => pw.Container(
            ...
            height: 10,
            color: const PdfColor.fromInt(0xFFBA260A)),
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerStyle: pw.TextStyle(
              ...
              color: PdfColors.white),
          headerDecoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0xFFBA260A)),
          oddRowDecoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0XFFFFD7BE)),
          cellHeight: 30,
          cellAlignments: {
    ...
    return pw.Container(
        ...
        child: pw.Row(
            ...
            children: [
              ...
              pw.SizedBox(width: 2 * PdfPageFormat.cm),
//  const PdfColor.fromInt(0xFFBA260A)
              pw.Expanded(
