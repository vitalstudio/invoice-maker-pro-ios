...
class PdfSimpleTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    pdf.addPage(
      ...
      build: (context) => [
        ...
        pw.Divider(color: PdfColors.grey, height: 0, thickness: 1.5),
        pw.SizedBox(height: 0.5 * PdfPageFormat.cm),
        ...
        buildTermAndConditions(dataModel.termAndCondition.toString(), boldFont,
            normalFont, dataModel.signatureImg ?? Uint8List(0)),
        pw.SizedBox(height: 1 * PdfPageFormat.cm),
      ],
  ...
  static Widget buildHeader(
    ...
    if (invoiceTitle.isEmpty) {
      titleCheck =  AppSingletons.isEditInvoice.value ? 'INVOICE' : 'ESTIMATE';
    } else {
