...
class PdfPinkBlueTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    final Uint8List imageData = await loadImageFromAssets('assets/images/pink_blue.jpg');
  ...
  static Widget buildItemDetail(
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          oddRowDecoration:
          const pw.BoxDecoration(color: PdfColor.fromInt(0x661E88E5)),
          cellHeight: 30,
          cellAlignments: {
