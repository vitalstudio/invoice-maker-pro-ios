...
class PdfPinkOffWhiteTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    await loadImageFromAssets('assets/images/pink_offWhite.jpg');
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerStyle: pw.TextStyle(
              ...
              font: boldFont,
              color: PdfColors.white),
          headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFFfa4b74)),

          oddRowDecoration: const pw.BoxDecoration(
              color: PdfColor.fromInt(0xFFFFC9CC)
          ),
            ...
            children: [
              ...
              pw.Expanded(
                  child: pw.Column(children: [
                    ...
                    pw.SizedBox(height: 0.5 * PdfPageFormat.cm),
                    pw.Container(
                        color: const PdfColor.fromInt(0xFFfa4b74),
