...
class PdfOrangeBlueTemplate {
  ...
  static Future<Uint8List> createPreviewPdf(
    ...
    final Uint8List backgroundImage = await loadImageFromAssets('assets/images/orange_blue.jpg');
  ...
  static Widget buildItemDetail(
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFF903c8c)),
          cellHeight: 30,
          oddRowDecoration: const pw.BoxDecoration(
            color: PdfColor.fromInt(0xFFFFF2FB)
          ),
          cellAlignments: {
              ...
              pw.Expanded(
                  child: pw.Column(children: [
                    ...
                    pw.Container(
                        ...
                        color: const PdfColor.fromInt(0xFF903c8c),
                        child: pw.Row(
                            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text(
