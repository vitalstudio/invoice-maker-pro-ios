...
class PdfPurpleBlueTemplate {
  ...
  static Future<Uint8List> createPreviewPdf(
    ...
    final Uint8List backgroundImage = await loadImageFromAssets('assets/images/purple_blue.jpg');
  ...
  static Widget buildItemDetail(
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFF4a4160)),
          cellHeight: 30,
              ...
              pw.Expanded(
                  child: pw.Column(children: [
                    ...
                    pw.Container(
                        ...
                        color: const PdfColor.fromInt(0xFF4a4160),
                        child: pw.Row(
                            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text(
