...
class PdfRedComboTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    final Uint8List imageData =
        await loadImageFromAssets('assets/images/tools.jpg');
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerStyle: pw.TextStyle(
              ...
              color: PdfColors.white),
          headerDecoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0xFFD90E0B)),
          oddRowDecoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0XFFFEC6B8)),
          cellHeight: 30,
          cellAlignments: {
    ...
    return pw.Container(
        ...
        child: pw.Row(
            ...
            children: [
              ...
              pw.SizedBox(width: 2 * PdfPageFormat.cm),
// const PdfColor.fromInt(0xFFD90E0B)
              pw.Expanded(
                ...
                pw.SizedBox(height: 0.5 * PdfPageFormat.cm),
                pw.Container(
                    color: const PdfColor.fromInt(0xFFD90E0B),
