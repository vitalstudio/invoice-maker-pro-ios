...
class PdfBlueTapTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    final Uint8List imageData =
        await loadImageFromAssets('assets/images/blue_temp.jpg');
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (format) => pw.Container(
            ...
            height: 10,
            color: const PdfColor.fromInt(0xFF1052EB)),
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerStyle: pw.TextStyle(
              ...
              color: PdfColors.white),
          headerDecoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0xFF1052EB)),
          oddRowDecoration:
              const pw.BoxDecoration(color: PdfColor.fromInt(0XFFBAC3FF)),
          cellHeight: 30,
          cellAlignments: {
