...
class PdfFourColorBoxTemplate {
  static Future<Uint8List> createPreviewPdf(
    ...
    await loadImageFromAssets('assets/images/four_color_box.jpg');
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        footer: (format) => pw.Container(
            ...
            height: 10,
            color: const PdfColor.fromInt(0xFF5B525B)),
    ...
    return pw.Container(
        ...
        child: pw.TableHelper.fromTextArray(
          ...
          headerStyle: pw.TextStyle(
              ...
              font: boldFont,
              color: PdfColors.white),
          headerDecoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFF5B525B)),
          oddRowDecoration:
          const pw.BoxDecoration(color: PdfColor.fromInt(0XFFBAAAB9)),
          cellHeight: 30,
          cellAlignments: {
